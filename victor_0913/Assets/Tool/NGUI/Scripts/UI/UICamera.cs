...
public class UICamera : MonoBehaviour
{
	...
	public class MouseOrTouch
	{
		...
		public UnityEngine.GameObject last;			// Last object under the touch or mouse
		public UnityEngine.GameObject current;		// Current game object under the touch or mouse
		public UnityEngine.GameObject pressed;		// Last game object to receive OnPress
		public UnityEngine.GameObject dragged;		// Game object that's being dragged
	...
	static public Vector2 lastEventPosition
	{
		get
		{
			...
			{
                UnityEngine.GameObject go = hoveredObject;
	...
	static UnityEngine.GameObject mGenericHandler;
	...
	static public UnityEngine.GameObject genericEventHandler { get { return mGenericHandler; } set { mGenericHandler = value; } }

	/// <summary>
	/// If events don't get handled, they will be forwarded to this game object.
	/// </summary>

	static public UnityEngine.GameObject fallThrough;

	public delegate void MoveDelegate (Vector2 delta);
	public delegate void VoidDelegate (UnityEngine.GameObject go);
	public delegate void BoolDelegate (UnityEngine.GameObject go, bool state);
	public delegate void FloatDelegate (UnityEngine.GameObject go, float delta);
	public delegate void VectorDelegate (UnityEngine.GameObject go, Vector2 delta);
	public delegate void ObjectDelegate (UnityEngine.GameObject go, UnityEngine.GameObject obj);
	public delegate void KeyCodeDelegate (UnityEngine.GameObject go, KeyCode key);
	...
	static UnityEngine.GameObject mTooltip = null;
	...
	static public UnityEngine.GameObject tooltipObject { get { return mTooltip; } }
	...
	static public bool IsPartOfUI (UnityEngine.GameObject go)
	{
	...
	static UnityEngine.GameObject mRayHitObject;
	static UnityEngine.GameObject mHover;
	static UnityEngine.GameObject mSelected;
	...
	static public UnityEngine.GameObject hoveredObject
	{
		get
		{
	...
	static public UnityEngine.GameObject controllerNavigationObject
	{
		get
		{
	...
	static public UnityEngine.GameObject selectedObject
	{
		get
		{
	...
	static public bool IsPressed (UnityEngine.GameObject go)
	{
		...
		for (int i = 0; i < list.size; ++i)
		{
			...
			else if (cam.eventType == EventType.UI_3D)
			{
				...
				if (hitCount > 1)
				{
					...
					{
                        UnityEngine.GameObject go = mRayHits[b].collider.gameObject;
#if UNITY_5_5_OR_NEWER
						UnityEngine.Profiling.Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
				...
				{
                    UnityEngine.GameObject go = mRayHits[0].collider.gameObject;
#if UNITY_5_5_OR_NEWER
					UnityEngine.Profiling.Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
					UIWidget w = go.GetComponent<UIWidget>();
					UnityEngine.Profiling.Profiler.EndSample();
			...
			else if (cam.eventType == EventType.UI_2D)
			{
				if (m2DPlane.Raycast(ray, out dist))
				{
					...
					if (hitCount > 1)
					{
						for (int b = 0; b < hitCount; ++b)
						{
                            UnityEngine.GameObject go = mOverlap[b].gameObject;
#if UNITY_5_5_OR_NEWER
							UnityEngine.Profiling.Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
							UIWidget w = go.GetComponent<UIWidget>();
							UnityEngine.Profiling.Profiler.EndSample();
	...
	static bool IsVisible (Vector3 worldPoint, UnityEngine.GameObject go)
	{
	...
	static public bool IsHighlighted (UnityEngine.GameObject go) { return (UICamera.hoveredObject == go); }
	...
	static public void Notify (UnityEngine.GameObject go, string funcName, object obj)
	{
	...
	bool HasCollider (UnityEngine.GameObject go)
	{
	...
	static public bool ShowTooltip (UnityEngine.GameObject go)
	{
		if (mTooltip != go)
		{
			if (mTooltip != null)
