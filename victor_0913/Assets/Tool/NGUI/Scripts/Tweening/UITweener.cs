...
public abstract class UITweener : MonoBehaviour
{
	...
	[HideInInspector] public UnityEngine.GameObject eventReceiver;
	...
	static public T Begin<T> (UnityEngine.GameObject go, float duration, float delay = 0f) where T : UITweener
	{
