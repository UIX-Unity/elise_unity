...
public class TweenTransform : UITweener
{
	...
	static public TweenTransform Begin (UnityEngine.GameObject go, float duration, Transform to) { return Begin(go, duration, null, to); }

	/// <summary>
	/// Start the tweening operation.
	/// </summary>

	static public TweenTransform Begin (UnityEngine.GameObject go, float duration, Transform from, Transform to)
	{
