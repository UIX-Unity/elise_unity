...
public class TweenPosition : UITweener
{
	...
	static public TweenPosition Begin (UnityEngine.GameObject go, float duration, Vector3 pos)
	{
	...
	static public TweenPosition Begin (UnityEngine.GameObject go, float duration, Vector3 pos, bool worldSpace)
	{
		TweenPosition comp = UITweener.Begin<TweenPosition>(go, duration);
