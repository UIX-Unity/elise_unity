...
#region Convenience accessor properties
	...
	static public UIWidget AddWidget (UnityEngine.GameObject go)
	{
	...
	static public UITexture AddTexture (UnityEngine.GameObject go)
	{
	...
	static public UI2DSprite Add2DSprite (UnityEngine.GameObject go)
	{
	...
	static public UISprite AddSprite (UnityEngine.GameObject go)
	{
	...
	static public UILabel AddLabel (UnityEngine.GameObject go)
	{
	...
	static public UIPanel AddPanel (UnityEngine.GameObject go)
	{
	...
	static void PasteLabel (UILabel lbl, bool fully)
	{
		if (fully)
		{
			...
			if (obj != null)
			{
				...
				{
					lbl.ambigiousFont = (obj as UnityEngine.GameObject).GetComponent<UIFont>();
				}
			}
