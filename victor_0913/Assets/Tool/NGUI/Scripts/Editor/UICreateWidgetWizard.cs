...
public class UICreateWidgetWizard : EditorWindow
{
	...
	static public bool ShouldCreate (UnityEngine.GameObject go, bool isValid)
	{
        ...
        UnityEngine.GameObject sel = EditorGUILayout.ObjectField(go, typeof(UnityEngine.GameObject), true, GUILayout.Width(140f)) as UnityEngine.GameObject;
	...
	void CreateLabel (UnityEngine.GameObject go)
	{
		GUILayout.BeginHorizontal();
	...
	void CreateSprite (UnityEngine.GameObject go)
	{
	...
	void CreateSimpleTexture (UnityEngine.GameObject go)
	{
	...
	void CreateButton (UnityEngine.GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreateImageButton (UnityEngine.GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreateToggle (UnityEngine.GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreateScrollBar (UnityEngine.GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreateSlider (UnityEngine.GameObject go, bool slider)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreateInput (UnityEngine.GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void CreatePopup (UnityEngine.GameObject go, bool isDropDown)
	{
		if (NGUISettings.atlas != null)
		{
	...
	void OnGUI ()
	{
        ...
        UnityEngine.GameObject go = NGUIEditorTools.SelectedRoot();
