...
public class UISnapshotPointEditor : Editor
{
	...
	public override void OnInspectorGUI ()
	{
        ...
        UnityEngine.GameObject prefab = GetPrefab();
    ...
    UnityEngine.GameObject GetPrefab ()
	{
        ...
        UnityEngine.GameObject go = PrefabUtility.FindPrefabRoot(t == null ? point.gameObject : t.gameObject);
		if (go == null) return null;

		// Actual prefab
		return PrefabUtility.GetCorrespondingObjectFromSource(go) as UnityEngine.GameObject;
	}
}
