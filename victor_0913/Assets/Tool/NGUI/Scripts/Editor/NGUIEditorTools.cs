...
static public class NGUIEditorTools
{
	...
	static UnityEngine.GameObject mPrevious;
	...
	static public UnityEngine.GameObject SelectedRoot () { return SelectedRoot(false); }

	/// <summary>
	/// Helper function that returns the selected root object.
	/// </summary>

	static public UnityEngine.GameObject SelectedRoot (bool createIfMissing)
	{
        UnityEngine.GameObject go = Selection.activeGameObject;
		...
		if (createIfMissing && go == null)
		{
			...
			if (go == null)
			{
                UIPanel panel = UnityEngine.GameObject.FindObjectOfType(typeof(UIPanel)) as UIPanel;
	...
	static public bool WillLosePrefab (UnityEngine.GameObject root)
	{
	...
	static public void Select (UnityEngine.GameObject go)
	{
	...
	static public UnityEngine.GameObject previousSelection { get { return mPrevious; } }
	...
	static public bool IsUniform (UnityEngine.GameObject go)
	{
	...
	static public void FixUniform (UnityEngine.GameObject go)
	{
	...
	static public bool SelectWidget (UnityEngine.GameObject start, Vector2 pos, bool inFront)
	{
	...
	{
        UnityEngine.GameObject go = EditorUtility.CreateGameObjectWithHideFlags("Temp", HideFlags.HideAndDontSave);
	...
	class MenuEntry
	{
		...
		public MenuEntry (string name, UnityEngine.GameObject go) { this.name = name; this.go = go; }
	}
		...
		for (int i = entries.Count; i > 0; )
		{
			...
			if (ent != null)
			{
                NGUIContextMenu.AddItem("Select/" + ent.name, Selection.activeGameObject == ent.go,
					delegate(object go) { Selection.activeGameObject = (UnityEngine.GameObject)go; }, ent.go);
			}
			else if (!divider)
			{
