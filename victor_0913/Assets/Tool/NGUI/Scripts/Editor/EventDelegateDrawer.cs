...
public class EventDelegateDrawer : PropertyDrawer
{
		...
		if (ps != null)
		{
			...
			for (int i = 0; i < ps.Length; i++)
			{
				...
				if (obj != null)
				{
					...
					if (type == typeof(UnityEngine.GameObject)) selGO = obj as UnityEngine.GameObject;
	...
	public override void OnGUI (Rect rect, SerializedProperty prop, GUIContent label)
	{
		...
		{
            UnityEngine.GameObject go = target.gameObject;
			...
			if (ps != null)
			{
				...
				for (int i = 0; i < ps.Length; i++)
				{
					...
					if (type == typeof(UnityEngine.GameObject)) selGO = param.obj as UnityEngine.GameObject;
