...
public class UIAtlasMaker : EditorWindow
{
	...
	public class SpriteEntry : UISpriteData
	{
		...
		public UnityEngine.GameObject tempGO;
		...
		else
		{
			...
			if (create)
			{
				...
				if (!string.IsNullOrEmpty(path))
				{
					...
					go = new UnityEngine.GameObject(atlasName);
					...
					// Select the atlas
					go = AssetDatabase.LoadAssetAtPath(path, typeof(UnityEngine.GameObject)) as UnityEngine.GameObject;
