...
static public class NGUIContextMenu
{
	...
	public delegate UIWidget AddFunc (UnityEngine.GameObject go);
	...
	static public void AddCommonItems (UnityEngine.GameObject target)
	{
		if (target != null)
		{
	...
	static void Attach (object obj)
	{
		...
		for (int i = 0; i < Selection.gameObjects.Length; ++i)
		{
            UnityEngine.GameObject go = Selection.gameObjects[i];
	...
	static void AddMissingItem<T> (UnityEngine.GameObject target, string name) where T : MonoBehaviour
	{
	...
	static public void AddHelp (UnityEngine.GameObject go, bool addSeparator)
	{
