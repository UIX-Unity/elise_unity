...
public class NGUISelectionTools
{
	...
	{
        Object[] gos = Selection.GetFiltered(typeof(UnityEngine.GameObject), SelectionMode.TopLevel);
	...
	static void ActivateDeactivate()
	{
		if (HasValidTransform())
		{
			...
			foreach (UnityEngine.GameObject go in gos) NGUITools.SetActive(go, val);
		}
	}
