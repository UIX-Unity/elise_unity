...
#region Selection
	...
	static public UnityEngine.GameObject SelectedRoot () { return NGUIEditorTools.SelectedRoot(); }
...
#region Create
	...
	{
        UnityEngine.GameObject go = NGUIEditorTools.SelectedRoot(true);
...
#region Options
	...
	{
        UnityEngine.GameObject go = Selection.activeGameObject ?? UICamera.list[0].gameObject;
