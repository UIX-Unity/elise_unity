...
#region Common functionality
	...
	public virtual void StartDragging ()
	{
		...
		if (!mDragging)
		{
			...
			{
				mPressed = false;
                UnityEngine.GameObject clone = transform.parent.gameObject.AddChild(gameObject);
	...
	protected virtual void OnClone (UnityEngine.GameObject original) { }
	...
	public void StopDragging (UnityEngine.GameObject go = null)
	{
		if (mDragging)
		{
			mDragging = false;
