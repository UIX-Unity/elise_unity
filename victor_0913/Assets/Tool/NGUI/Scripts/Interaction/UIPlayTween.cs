...
public class UIPlayTween : MonoBehaviour
{
	...
	public UnityEngine.GameObject tweenTarget;
	...
	void CustomHoverListener (UnityEngine.GameObject go, bool isOver)
	{
		if (!this) return;
		var myGo = gameObject;
	...
	{
		mActive = 0;
        UnityEngine.GameObject go = (tweenTarget == null) ? gameObject : tweenTarget;
