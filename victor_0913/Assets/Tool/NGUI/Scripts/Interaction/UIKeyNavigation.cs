...
public class UIKeyNavigation : MonoBehaviour
{
	...
	static public UIKeyNavigation current
	{
		get
		{
            UnityEngine.GameObject go = UICamera.hoveredObject;
	...
	static bool IsActive (UnityEngine.GameObject go)
	{
	...
	public UnityEngine.GameObject GetLeft ()
	{
	...
	public UnityEngine.GameObject GetRight ()
	{
	...
	public UnityEngine.GameObject GetUp ()
	{
	...
	public UnityEngine.GameObject GetDown ()
	{
	...
	public UnityEngine.GameObject Get (Vector3 myDir, float x = 1f, float y = 1f)
	{
	...
	static protected Vector3 GetCenter (UnityEngine.GameObject go)
	{
	...
	public virtual void OnKey (KeyCode key)
	{
		...
		if (key == KeyCode.Tab)
		{
            UnityEngine.GameObject go = onTab;
