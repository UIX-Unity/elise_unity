...
{
	public List<UnityEngine.GameObject> activate;
	public List<UnityEngine.GameObject> deactivate;

	[HideInInspector][SerializeField] UnityEngine.GameObject target;
	...
	void Set (UnityEngine.GameObject go, bool state)
	{
		if (go != null)
		{
