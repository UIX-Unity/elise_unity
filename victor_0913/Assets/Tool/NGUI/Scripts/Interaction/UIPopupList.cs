...
public class UIPopupList : UIWidgetContainer
{
	...
	static protected UnityEngine.GameObject mChild;
	...
	[System.NonSerialized] protected UnityEngine.GameObject mSelection;
	[System.NonSerialized] protected int mOpenFrame = 0;

	// Deprecated functionality
	[HideInInspector][SerializeField] UnityEngine.GameObject eventReceiver;
	...
	protected virtual void OnItemHover (UnityEngine.GameObject go, bool isOver)
	{
		if (isOver)
		{
	...
	protected virtual void OnItemPress (UnityEngine.GameObject go, bool isPressed)
	{
	...
	protected virtual void OnItemClick (UnityEngine.GameObject go)
	{
	...
	protected virtual void AnimatePosition (UIWidget widget, bool placeAbove, float bottom)
	{
        ...
        UnityEngine.GameObject go = widget.gameObject;
	...
	public virtual void Show ()
	{
		if (enabled && NGUITools.GetActive(gameObject) && mChild == null && isValid && items.Count > 0)
		{
            ...
            mChild = new UnityEngine.GameObject("Drop-down List");
