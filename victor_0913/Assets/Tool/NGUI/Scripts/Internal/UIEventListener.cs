...
public class UIEventListener : MonoBehaviour
{
	...
	void OnDrop (UnityEngine.GameObject go)		{ if (isColliderEnabled && onDrop != null) onDrop(gameObject, go); }
	...
	static public UIEventListener Get (UnityEngine.GameObject go)
	{
