...
static public class NGUITools
{
	...
	static public AudioSource PlaySound (AudioClip clip, float volume, float pitch)
	{
		...
		if (clip != null && volume > 0.01f)
		{
			...
			{
                AudioListener[] listeners = UnityEngine.GameObject.FindObjectsOfType(typeof(AudioListener)) as AudioListener[];
				...
				if (mListener == null)
				{
					...
					if (cam == null) cam = UnityEngine.GameObject.FindObjectOfType(typeof(Camera)) as Camera;
...
//    }
	...
	static public string GetHierarchy (UnityEngine.GameObject obj)
	{
		if (obj == null) return "";
	...
	{
		return UnityEngine.GameObject.FindObjectsOfType(typeof(T)) as T[];
	}
	...
	static public void AddWidgetCollider (UnityEngine.GameObject go) { AddWidgetCollider(go, false); }

	/// <summary>
	/// Add a collider to the game object containing one or more widgets.
	/// </summary>

	static public void AddWidgetCollider (UnityEngine.GameObject go, bool considerInactive)
	{
		if (go != null)
		{
			// 3D collider
	...
	static public void UpdateWidgetCollider (UnityEngine.GameObject go)
	{
	...
	static public void UpdateWidgetCollider (UnityEngine.GameObject go, bool considerInactive)
	{
		if (go != null)
		{
	...
	static public void UpdateWidgetCollider (BoxCollider box, bool considerInactive)
	{
		if (box != null)
		{
            UnityEngine.GameObject go = box.gameObject;
	...
	static public UnityEngine.GameObject AddChild (UnityEngine.GameObject parent) { return AddChild(parent, true, -1); }

	/// <summary>
	/// Add a new child game object.
	/// </summary>

	static public UnityEngine.GameObject AddChild (this UnityEngine.GameObject parent, int layer) { return AddChild(parent, true, layer); }

	/// <summary>
	/// Add a new child game object.
	/// </summary>

	static public UnityEngine.GameObject AddChild (this UnityEngine.GameObject parent, bool undo) { return AddChild(parent, undo, -1); }

	/// <summary>
	/// Add a new child game object.
	/// </summary>

	static public UnityEngine.GameObject AddChild (this UnityEngine.GameObject parent, bool undo, int layer)
	{
	...
	static public UnityEngine.GameObject AddChild (this UnityEngine.GameObject parent, UnityEngine.GameObject prefab) { return parent.AddChild(prefab, -1); }

	/// <summary>
	/// Instantiate an object and add it to the specified parent.
	/// </summary>

	static public UnityEngine.GameObject AddChild (this UnityEngine.GameObject parent, UnityEngine.GameObject prefab, int layer)
	{
		var go = UnityEngine.GameObject.Instantiate(prefab) as UnityEngine.GameObject;
#if UNITY_EDITOR
	...
	static public int CalculateRaycastDepth (UnityEngine.GameObject go)
	{
	...
	static public int CalculateNextDepth (UnityEngine.GameObject go)
	{
		if (go)
		{
			int depth = -1;
	...
	static public int CalculateNextDepth (UnityEngine.GameObject go, bool ignoreChildrenWithColliders)
	{
	...
	static public int AdjustDepth (UnityEngine.GameObject go, int adjustment)
	{
		if (go != null)
		{
	...
	static public void BringForward (UnityEngine.GameObject go)
	{
	...
	static public void PushBack (UnityEngine.GameObject go)
	{
		int val = AdjustDepth(go, -1000);
		if (val == 1) NormalizePanelDepths();
		else if (val == 2) NormalizeWidgetDepths();
	...
	static public void NormalizeWidgetDepths (UnityEngine.GameObject go)
	{
	...
	static public UIPanel CreateUI (Transform trans, bool advanced3D, int layer)
	{
		...
		if (root == null)
		{
			for (int i = 0, imax = UIPanel.list.Count; i < imax; ++i)
			{
                ...
                UnityEngine.GameObject go = p.gameObject;
		...
		if (root == null)
		{
            UnityEngine.GameObject go = NGUITools.AddChild(null, false);
	...
	static public T AddChild<T> (this UnityEngine.GameObject parent) where T : Component
	{
        UnityEngine.GameObject go = AddChild(parent);
		string name;
	...
	static public T AddChild<T> (this UnityEngine.GameObject parent, bool undo) where T : Component
	{
        UnityEngine.GameObject go = AddChild(parent, undo);
		string name;
	...
	static public T AddWidget<T> (this UnityEngine.GameObject go, int depth = int.MaxValue) where T : UIWidget
	{
	...
	static public UISprite AddSprite (this UnityEngine.GameObject go, UIAtlas atlas, string spriteName, int depth = int.MaxValue)
	{
	...
	static public UnityEngine.GameObject GetRoot (UnityEngine.GameObject go)
	{
		Transform t = go.transform;
	...
	static public T FindInParents<T> (UnityEngine.GameObject go) where T : Component
	{
	...
	static public void Destroy (UnityEngine.Object obj)
	{
		if (obj)
		{
			if (obj is Transform)
			{
                ...
                UnityEngine.GameObject go = t.gameObject;
	...
	{
        UnityEngine.GameObject[] gos = UnityEngine.GameObject.FindObjectsOfType(typeof(UnityEngine.GameObject)) as UnityEngine.GameObject[];
	...
	static public void SetActive (UnityEngine.GameObject go, bool state) { SetActive(go, state, true); }
	...
	static public void SetActive (UnityEngine.GameObject go, bool state, bool compatibilityMode)
	{
		if (go)
		{
			if (state)
	...
	static public void SetActiveChildren (UnityEngine.GameObject go, bool state)
	{
		Transform t = go.transform;
	...
	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	static public bool GetActive (UnityEngine.GameObject go)
	{
	...
	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	static public void SetActiveSelf (UnityEngine.GameObject go, bool state)
	{
		go.SetActive(state);
	}
	...
	static public void SetLayer (UnityEngine.GameObject go, int layer)
	{
		go.layer = layer;
	...
	static public void MarkParentAsChanged (UnityEngine.GameObject go)
	{
	...
	static public T AddMissingComponent<T> (this UnityEngine.GameObject go) where T : Component
	{
#if UNITY_FLASH
	...
	static public void Execute<T> (UnityEngine.GameObject go, string funcName) where T : Component
	{
	...
	static public void ExecuteAll<T> (UnityEngine.GameObject root, string funcName) where T : Component
	{
	...
	static public void ImmediatelyCreateDrawCalls (UnityEngine.GameObject root)
	{
...
//#endif
	...
	static UnityEngine.GameObject mGo;
