...
public abstract class UIRect : MonoBehaviour
{
	...
	[System.NonSerialized] protected UnityEngine.GameObject mGo;
	...
	public UnityEngine.GameObject cachedGameObject { get { if (mGo == null) mGo = gameObject; return mGo; } }
	...
	public void SetAnchor (UnityEngine.GameObject go)
	{
	...
	public void SetAnchor (UnityEngine.GameObject go, int left, int bottom, int right, int top)
	{
		Transform t = (go != null) ? go.transform : null;
	...
	public void SetAnchor (UnityEngine.GameObject go, float left, float bottom, float right, float top)
	{
		Transform t = (go != null) ? go.transform : null;
