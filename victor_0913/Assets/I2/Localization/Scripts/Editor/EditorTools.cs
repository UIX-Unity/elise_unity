...
{	
	public class GUITools
	{
		...
		public static bool ObjectExistInScene(UnityEngine.GameObject Obj )
		{
		...
		public static IEnumerable<UnityEngine.GameObject> SceneRoots()
		{
			var prop = new HierarchyProperty(HierarchyType.GameObjects);
			var expanded = new int[0];
			while (prop.Next(expanded)) {
				yield return prop.pptrValue as UnityEngine.GameObject;
			}
		}
		
		public static List<UnityEngine.GameObject> SceneRootsList()
		{
			return new List<UnityEngine.GameObject>(SceneRoots());
		}
