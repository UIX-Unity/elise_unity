...
namespace I2.Loc
{
    public static partial class LocalizationManager
    {
        ...
        public static string GetTranslation(string Term, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, UnityEngine.GameObject localParametersRoot = null, string overrideLanguage = null)
        {
        ...
        public static string GetTermTranslation(string Term, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, UnityEngine.GameObject localParametersRoot = null, string overrideLanguage = null)
        {
        ...
        public static bool TryGetTranslation(string Term, out string Translation, bool FixForRTL = true, int maxLineLengthForRTL = 0, bool ignoreRTLnumbers = true, bool applyParameters = false, UnityEngine.GameObject localParametersRoot = null, string overrideLanguage = null)
        {
            Translation = null;
