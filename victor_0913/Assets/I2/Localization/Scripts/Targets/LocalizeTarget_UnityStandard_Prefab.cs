...
namespace I2.Loc
{
    ...
    public class LocalizeTarget_UnityStandard_Prefab : LocalizeTarget<UnityEngine.GameObject>
    {
        ...
        {
            UnityEngine.GameObject NewPrefab = cmp.FindTranslatedObject<UnityEngine.GameObject>(mainTranslation);
            if (NewPrefab == null)
                return null;

            UnityEngine.GameObject current = mTarget as UnityEngine.GameObject;
            ...
            Transform locTr = cmp.transform;
            Transform mNew = (mTarget as UnityEngine.GameObject).transform;
